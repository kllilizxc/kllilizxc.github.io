    ...
    for (var i = 0; i < lines.length; i++) {
      ...
      if (VERTEX_RE.test(line)) {
        ...
        */
        ...
        var vertexIndicesOfFace = [elements[0].split('/')[0],
                                   elements[1].split('/')[0],
                                   elements[2].split('/')[0]];

       var verticesOfFace = [];
       verticesOfFace.push([verts[(vertexIndicesOfFace[0] - 1) * 3 + 0],
                            verts[(vertexIndicesOfFace[0] - 1) * 3 + 1],
                            verts[(vertexIndicesOfFace[0] - 1) * 3 + 2]]);

      verticesOfFace.push([verts[(vertexIndicesOfFace[1] - 1) * 3 + 0],
                           verts[(vertexIndicesOfFace[1] - 1) * 3 + 1],
                           verts[(vertexIndicesOfFace[1] - 1) * 3 + 2]]);

       verticesOfFace.push([verts[(vertexIndicesOfFace[2] - 1) * 3 + 0],
                            verts[(vertexIndicesOfFace[2] - 1) * 3 + 1],
                            verts[(vertexIndicesOfFace[2] - 1) * 3 + 2]]);

      var v0 = [verticesOfFace[1][0] - verticesOfFace[0][0],
                verticesOfFace[1][1] - verticesOfFace[0][1],
                verticesOfFace[1][2] - verticesOfFace[0][2]];

      var v1 = [verticesOfFace[2][0] - verticesOfFace[0][0],
                verticesOfFace[2][1] - verticesOfFace[0][1],
                verticesOfFace[2][2] - verticesOfFace[0][2]];

      var normal = [v0[1] * v1[2] - v0[2] * v1[1],
                    v0[2] * v1[0] - v0[0] * v1[2],
                    v0[0] * v1[1] - v0[1] * v1[0]];
        ...
        for (var j = 0, eleLen = elements.length; j < eleLen; j++){
            ...
            if(elements[j] in unpacked.hashindices){
                ...
                if(vertNormals.length) {
                  ...
                  unpacked.norms.push(normal[0]);
                  unpacked.norms.push(normal[1]);
                  unpacked.norms.push(normal[2]);
                }
